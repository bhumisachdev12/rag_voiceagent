"""Text-Based AI Agent (for testing without microphone)"""
import os
import json
...
class TextAgent:
    def __init__(self):
        ...
        self.system_prompt = """You are a helpful AI assistant that manages to-do lists and remembers important user interactions.
...
When the user shares something important (like "my birthday is June 15" or "I love pizza"), acknowledge it and remember it."""
    ...
    def run(self):
        """Main agent loop"""
        print("=" * 60)
        print("🤖 Text-Based AI Agent with Memory & Tools")
        print("=" * 60)
